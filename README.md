# Big Data - Study Materials

Educational materials repository for the Big Data course at Universidad Pontificia Bolivariana.
...
- `03-delta-lake/`: Implementation with Delta Lake

### Module 5: Data Science
End-to-end data science with Spark.
- `01-exploratory-analysis/`: EDA from the Lakehouse
- `02-feature-engineering/`: Feature preparation with DataFrames
- `03-mllib/`: Model training, evaluation, and pipelines
